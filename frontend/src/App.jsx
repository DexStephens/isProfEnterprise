...
const url = 'http://127.0.0.1:8080/api'; // Specify the complete URL including the protocol and host
...
function App() {
  ...
  useEffect(() => {
    if (filter != "") {
      setProfessors(professors.filter((professor) => professor.name.toLowerCase().includes(filter.toLowerCase())))
    } else {
  ...
  return (
    ...
    <div className="container mx-auto p-4">
        <h1 className="text-2xl font-semibold text-blue-700 mb-4">IS Professors</h1>
